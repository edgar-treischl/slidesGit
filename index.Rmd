...
meta() %>%
  ...
  meta_social(
    ...
    image = "https://edgar-treischl.github.io/gist/logo.png",
    image_alt = "Images from Allison Horst"
  )
...
### Once R Studio is connected, you can work with the Git pane:
...
### Push, and pull, and let it all out  `r emoji::emoji("dancing")`
