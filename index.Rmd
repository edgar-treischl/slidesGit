...
### `r emoji::emoji("one")` Intro Git/GitHub
### `r emoji::emoji("two")` Getting Started with R Studio
### `r emoji::emoji("three")` Basics of Git and Workflow
...
> Switched to a new branch 'feature/shiny_map'
```
...
.pull-right[
<figure>
    <a href="https://gist.github.com/bryanbraun/8c93e154a93a08794291df1fcdce6918" target="_blank"><img src="images/git_branches.png" alt="Pro Git by Chacon and Straub" width="90%"/></a>
    <figcaption style = "color: darkgray;">'Source: bryanbraun'</figcaption>
</figure>
...
<br/>
<figure>
  <img src="images/git_merge.gif" alt="Git Merge Meme" width="90%"/>
</figure>
...
<figure>
    <a href="https://allisonhorst.com" target="_blank"><img src="images/allison_horst_comits.png" alt="Pro Git by Chacon and Straub" width="100%"/></a>
    <figcaption style = "color: darkgray;">'Allison Horst'</figcaption>
</figure>
...
[`r icons::fontawesome("file-pdf")` Slides](https://github.com/edgar-treischl/slidesGit/blob/main/slides_git.pdf)
