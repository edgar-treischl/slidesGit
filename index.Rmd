...
#'<a href="#1">🏠 Introduction to Git(Hub)</a>'
#'#

# xaringanExtra::use_banner(
#   top_left = 'Treischl: Introduction to Git(Hub)',
#   exclude = "title-slide"
# )
...
### with the or `r emoji::emoji("rocket")` usethis package
...
---
## 02: New Vocabulary `r emoji::emoji("sword")` 


.pull-left[

No but, Git can be scary because it's full of technical jargon*:
...
* As often, R Studio helps us to work with Git.
...
#### `r emoji::emoji("congratulations")` ... you're connected!

---
## 02: Create a Repository on GitHub
...
---
## 02: Git Pane in RStudio I

<img src="images/Fig_0906.png" style="width: 80%"/>

---
## 02: Git Pane in RStudio II
...
---
## 03: Troubleshooting `r emoji::emoji("skull")`
...
<div class="info-box">
  <i>`r emoji::emoji("parrot")`️️</i> The gist package provides a set of functions to work with GitHub Gist. It allows you to copy, create, and delete gists via the GitHub API. Moreover, it comes with an R Studio addin - a shiny app - to manage your Gists.
</div>
