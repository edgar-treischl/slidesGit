...
#### Once R Studio is connected to GitHub, you can work with the Git pane in R Studio:
...
### Push and pull and let it all out  `r emoji::emoji("dancing")` directly from R Studio
